from wtforms import Form, StringField, PasswordField, SelectField, IntegerField, BooleanField
...
class NewMangaForm(Form):
    ...
    publisher = SelectField('Publisher', choices=[('planet', 'Planet Manga'), ('star', 'StarComics'), ('jpop', 'J-POP'), ('goen','GOEN')])
